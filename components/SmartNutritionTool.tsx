                  ...
                  <div className="flex flex-col h-full animate-fade-in-up p-12 overflow-y-auto no-scrollbar">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                       {[ 
                         ...
                         <div key={i} className="group/card p-8 bg-brand-cream/10 dark:bg-white/5 rounded-[45px] border border-brand-dark/5 dark:border-white/5 text-center transition-all hover:bg-white dark:hover:bg-brand-dark/80 duration-700">
                            <div className={`w-14 h-14 ${m.bg} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl`}>
                               {m.i}
                            </div>
                            <h5 className="font-serif font-bold text-brand-dark dark:text-white mb-3 text-lg leading-tight line-clamp-2">{m.d?.name || '---'}</h5>
                            <div className="text-[10px] text-brand-primary font-bold">{m.d?.calories || '---'} KCAL</div>
                         </div>
                       ))}
                    </div>
