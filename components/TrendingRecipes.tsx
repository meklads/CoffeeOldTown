...
const TrendingRecipes: React.FC = () => {
  ...
  return (
    <section className="py-32 bg-brand-light dark:bg-brand-dark transition-colors duration-1000">
            ...
            >
               <div className="relative aspect-[4/5] rounded-[45px] overflow-hidden mb-6 bg-brand-sand/10 shadow-4xl transition-all duration-1000">
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                     <span className="text-[8px] font-black uppercase tracking-[0.5em] text-brand-primary block mb-2">{recipe.category}</span>
                     <h3 className="text-2xl font-serif font-bold text-white leading-tight group-hover:text-brand-primary transition-colors duration-500">{recipe.title}</h3>
                  </div>
